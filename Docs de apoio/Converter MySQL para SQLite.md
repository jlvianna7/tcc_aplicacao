...
**Gostaria que eu te ajudasse a criar uma função de cache no Streamlit para que suas consultas no SQLite fiquem ainda mais rápidas e não sobrecarreguem o app?**