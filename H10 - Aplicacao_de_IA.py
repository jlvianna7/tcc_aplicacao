...
st.sidebar.markdown("**H10 - Áreas de utilização de Inteligência artificial **")

# %% Evolução anual, geral do uso de Inteligência artificial

st.subheader(f"Evolução da utilização de :yellow-background[Inteligência artificial] por área de aplicação")
...
#with open("G:/Meu Drive/MBA - USP/TCC/Resultados preliminares/Novos dados/IA_aplic_totais.sql", "w", encoding="utf-8") as arquivo:
 #   arquivo.write(sql)
...
col1.subheader("Evolução da utilização de :yellow-background[Inteligência artificial] conforme área de aplicação")
col2.write(' ')
col3.write(' ')
...
col1.write(' ')
col1.write(' ')
col1.markdown("**Proporção de empresas que utilizam :yellow-background[Inteligência artificial] por Mercado de atuação**")
col2.write(' ')
col3.write(' ')
...
fig_m = px.bar(dfM1, y="% de Empresas que utilizam", text="valor", color="% de Empresas que utilizam", height=640, color_continuous_scale='Portland')
...
fig_p = px.bar(dfP1, y="% de Empresas que utilizam", text="valor", color="% de Empresas que utilizam", height=500, color_continuous_scale='Portland')
