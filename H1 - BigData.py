# Execução das pesquisas sobre Big Data
#
# %% importa pacotes
...
col2.write(' ')
col3.markdown("**Proporção de empresas que utilizam :yellow-background[Big Data]**")
...
col3.line_chart(dfl, x="Ano pesquisa", y="% de Empresas que utilizam", color="Análise", height=450)

############################################   BLOCO 2  #############################################

#col1, col2, col3 = st.columns([0.49, 0.02, 0.49])

#col1.markdown('**Evolução cronológica do uso de :yellow-background[Big Data], por mercado de atuação**')
#col2.write(' ')
#col3.markdown('**Evolução cronológica do uso de :yellow-background[Big Data], por porte de empresa**')
...
#col1.markdown('**% de utilização de :yellow-background[Big Data] por MERCADO de atuação, no ano selecionado**')
#col2.write(' ')
#col3.markdown('**% de utilização de :yellow-background[Big Data] por PORTE de empresa, no ano selecionado**')
