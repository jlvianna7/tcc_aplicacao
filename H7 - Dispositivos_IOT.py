# H7 - EMPRESAS QUE UTILIZARAM DISPOSITIVOS INTELIGENTES OU INTERNET DAS COISAS
#
...
# TOTAL PARA O INDICADOR H7 - EMPRESAS QUE UTILIZARAM DISPOSITIVOS INTELIGENTES OU INTERNET DAS COISAS


st.sidebar.color_picker = "#FF7F27"
#st.sidebar.write("H1 - Empresas que fazem análises de Dispositivos IoT")
st.sidebar.markdown("**H7 - Empresas que utilizam Dispositivos IoT**")
...
#####
sql = (
    f'SELECT ano_pesquisa "Ano pesquisa", contexto "Aplicação", qtd_resposta_sim "% de Empresas que utilizam" FROM ft_h8a_totais '
    F'WHERE ANO_PESQUISA > "2015" ' 
    f'UNION '
    f'SELECT ano_pesquisa "Ano pesquisa", contexto "Aplicação", qtd_resposta_sim "% de Empresas que utilizam" FROM ft_h8b_totais '
    F'WHERE ANO_PESQUISA > "2015" ' 
    f'UNION '
    f'SELECT ano_pesquisa "Ano pesquisa", contexto "Aplicação", qtd_resposta_sim "% de Empresas que utilizam" FROM ft_h8c_totais '
    F'WHERE ANO_PESQUISA > "2015" ' 
    f'UNION '
    f'SELECT ano_pesquisa "Ano pesquisa", contexto "Aplicação", qtd_resposta_sim "% de Empresas que utilizam" FROM ft_h8d_totais '
    F'WHERE ANO_PESQUISA > "2015" ' 
    f'UNION '
    f'SELECT ano_pesquisa "Ano pesquisa", contexto "Aplicação", qtd_resposta_sim "% de Empresas que utilizam" FROM ft_h8e_totais '
    F'WHERE ANO_PESQUISA > "2015" ' 
    f'UNION '
    f'SELECT ano_pesquisa "Ano pesquisa", contexto "Aplicação", qtd_resposta_sim "% de Empresas que utilizam" FROM ft_h8f_totais '
    F'WHERE ANO_PESQUISA > "2015" ' 
...
sql = (
    ...
    f'FROM usp_dsa.ft_h7_mercado f, usp_dsa.dm_mercado_atuacao d '
...
sql = (
    ...
    f'FROM usp_dsa.ft_h7_porte f, usp_dsa.dm_porte_empresa d '
