# H4 - EMPRESAS, POR REALIZAÇÃO DE IMPRESSÃO 3D
#
# %% importa pacotes
...
# TOTAL PARA O INDICADOR H4 - EMPRESAS, POR REALIZAÇÃO DE IMPRESSÃO 3D


st.sidebar.color_picker = "#FF7F27"
#st.sidebar.write("H1 - Empresas que fazem análises de Impressão 3D")
st.sidebar.markdown("**H4 - Empresas que utilizam Impressão 3D**")

# %% Evolução anual, geral do uso de Impressão 3D

st.subheader("Evolução da utilização de :yellow-background[Impressão 3D]")
...
col2.write(' ')
col3.markdown("**Proporção de empresas que utilizam :yellow-background[Impressão 3D]**")
...
col3.line_chart(df["% Empresas que utilizam"].astype(float), color='#FF7F27')
...
col1.markdown('**Evolução cronológica do uso de :yellow-background[Impressão 3D], por mercado de atuação**')
col2.write(' ')
col3.markdown('**Evolução cronológica do uso de :yellow-background[Impressão 3D], por porte de empresa**')
...
sql = (
    ...
    f'FROM usp_dsa.ft_h4_mercado f, usp_dsa.dm_mercado_atuacao d '
...
sql = (
    ...
    f'FROM usp_dsa.ft_h4_porte f, usp_dsa.dm_porte_empresa d '
...
col1.markdown('**% de utilização de :yellow-background[Impressão 3D] por MERCADO de atuação, no ano selecionado**')
col2.write(' ')
col3.markdown('**% de utilização de :yellow-background[Impressão 3D] por PORTE de empresa, no ano selecionado**')
