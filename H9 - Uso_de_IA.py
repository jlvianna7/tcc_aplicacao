...
#col1, col2, col3 = st.columns([0.98, 0.02, 0.93])
...
col1.bar_chart(dfl, x="Ano pesquisa", y="% de Empresas que utilizam", color="Aplicação", stack=False)
...
col1.markdown('**Evolução cronológica do uso de :yellow-background[Inteligência artificial], por mercado de atuação**')
col2.write(' ')
col3.markdown('**Evolução cronológica do uso de :yellow-background[Inteligência artificial], por porte de empresa**')
...
col1.markdown('**% de utilização de :yellow-background[Inteligência artificial] por MERCADO de atuação, no ano selecionado**')
col2.write(' ')
col3.markdown('**% de utilização de :yellow-background[Inteligência artificial] por PORTE de empresa, no ano selecionado**')
